...
object BindingDsl {
  ...
  object Api {
    ...
    /**
      ...
      */
    case class SingleEventBinder[C <: DomainCommand: ClassTag, E <: DomainEvent: ClassTag, F[_]](cmdHandler: C => F[immutable.Seq[E]])
    ...
    /**
      ...
      */
    case class ManyEventsBinder[C <: DomainCommand: ClassTag, E <: DomainEvent: ClassTag, F[_]](cmdHandler: C => F[immutable.Seq[E]])
                                                                                               (consInvoker: PartialFunction[C, F[immutable.Seq[E]]] => CommandHandlerInvoker[C, E]) {
