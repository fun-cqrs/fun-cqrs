...
import io.strongtyped.funcqrs.akka.{AssignedAggregateId, AggregateManager, AutoGeneratedAggregateId, ProjectionActor}
import io.strongtyped.funcqrs.{Tags, Behavior, Tag}
